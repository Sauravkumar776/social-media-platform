...
const ProfilePage = () => {
  ...
  return (
    <div className={`font-sans antialiased leading-normal tracking-wider bg-cover ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`} style={{ backgroundImage: "url('https://source.unsplash.com/1L71sPT5XKc')" }}>
